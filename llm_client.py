...
class LLMClient:
    ...
    def invoke(self, query: str, response_type: str = "text", system_prompt: str = None) -> dict:
        prompt = system_prompt if system_prompt is not None else TOOL_SELECTION_SYSTEM_PROMPT
